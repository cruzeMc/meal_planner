        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s2 center">
                        ...
                        <div class="row">
                            <div class="input-field col s10">
                                <button class="btn waves-effect waves-light purple lighten-2" onclick="getMeal()">Generate</button>
                            </div>
                        </div>
                    </div>
                <div class="col s10 center">
                    ...
                    <div>
                        <br><br>
                        <p><h5>Total Calories:</h5></p>
                        <a class="btn-floating btn-large waves-effect waves-light purple lighten-2"><span id="sumOfCalories">0</span></a>
                    </div>
                </div>
            </div>
        </div>
